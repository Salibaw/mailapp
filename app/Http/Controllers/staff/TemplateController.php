...
class TemplateController extends Controller
{
            ...
            return DataTables::of($templates)
                ...
                ->addColumn('action', function ($template) {
                    return '
                        ...
                        <form action="' . route('staff.templates.destroy', $template->id) . '" method="POST" class="delete-form inline-block">
                            ' . csrf_field() . '
                            ' . method_field('DELETE') . '
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.templates.index')->with('success', 'Template berhasil dibuat.');
    }
    ...
    public function update(Request $request, TemplateSurat $template)
    {
        ...
        return redirect()->route('staff.templates.index')->with('success', 'Template berhasil diperbarui.');
    }
    ...
    {
        $template->delete();
        return redirect()->route('staff.templates.index')->with('success', 'Template berhasil dihapus.');
    }
    public function show(TemplateSurat $templateSurat)
    {
        return response()->json([
            ...
            'isi_template' => $templateSurat->isi_template,
        ]);
    }
}
