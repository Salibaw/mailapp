                ...
                <ul>
                    <li>
                        <a href="{{ route('mahasiswa.dashboard') }}"
                            class="flex items-center px-4 py-2 {{ request()->routeIs('mahasiswa.dashboard') ? 'bg-indigo-600' : 'hover:bg-indigo-700' }}">
                            <i class="fas fa-tachometer-alt mr-2"></i> Dashboard
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('mahasiswa.surat-masuk.index') }}"
                            class="flex items-center px-4 py-2 {{ request()->routeIs('mahasiswa.surat-masuk.*') ? 'bg-indigo-600' : 'hover:bg-indigo-700' }}">
                            <i class="fas fa-inbox mr-2"></i> Surat Masuk
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('mahasiswa.surat-keluar.index') }}"
                            class="flex items-center px-4 py-2 {{ request()->routeIs('mahasiswa.surat-keluar.*') ? 'bg-indigo-600' : 'hover:bg-indigo-700' }}">
